(function ($, window, document, undefined) {
  ...
  $doc.ready(function () {
    ...
    $win.load(function () {
      var $sliderSecond = $(".slider-categories");
      if (!$sliderSecond.length) {
        return;
      }
      ...
      var ww = $win.width(),
        ...
        config = {
          ...
          prev: {
            button: ".slider-categories-actions .slider-prev",
            key: "left",
          },
          next: {
            button: ".slider-categories-actions .slider-next",
            key: "right",
          },
          pagination: {
            container: ".slider-categories-paging",
          },
          scroll: {
            items: 1,
          },
